...
def parse_args():
    ...
    parser.add_argument('--batch_size', type=int, default=4, help='batch size in testing [default: 24]')
    parser.add_argument('--gpu', type=str, default='4', help='specify gpu device [default: 0]')
    parser.add_argument('--num_point', type=int, default=2048, help='Point Number [default: 2048]')
    parser.add_argument('--log_dir', type=str, default='deepglint_realregseg', help='Experiment root')
...
def main(args):
    ...
    TEST_DATASET = OurDataset(npoints=args.num_point, split='test', normal_channel=args.normal)
