...
- fork a copy of info-ruc/Web-20
...
- git clone https://github.com/$yourname$/Web-20.git
...
- create a pull request on github.com to merge your commit with info-ruc/Web-20
